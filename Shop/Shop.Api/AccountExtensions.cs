...
namespace Shop
{
    public static partial class AccountExtensions
    {
        ...
        /// Reference to the Shop.IAccount.
        /// </param>
        /// <param name='model'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Shop.Models.ExternalLoginViewModel>> result = await operations.GetExternalLoginsWithOperationResponseAsync(returnUrl, generateState, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Shop.Models.ManageInfoViewModel> result = await operations.GetManageInfoWithOperationResponseAsync(returnUrl, generateState, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Shop.Models.UserInfoViewModel> result = await operations.GetUserInfoWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
